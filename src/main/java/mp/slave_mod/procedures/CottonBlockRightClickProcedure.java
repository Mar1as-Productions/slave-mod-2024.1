...
public class CottonBlockRightClickProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z) {
		if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlaveModModBlocks.COTTONSTAGE_5.get()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = SlaveModModBlocks.COTTONSTAGE_6.get().defaultBlockState();
			...
			if (world instanceof ServerLevel _level) {
				ItemEntity entityToSpawn = new ItemEntity(_level, (x + Math.random()), (y + Math.random()), (z + Math.random()), new ItemStack(SlaveModModItems.HARVESTED_COTTON.get()));
		...
		} else if ((world.getBlockState(BlockPos.containing(x, y, z))).getBlock() == SlaveModModBlocks.COTTONSTAGE_7.get()) {
			{
				BlockPos _bp = BlockPos.containing(x, y, z);
				BlockState _bs = SlaveModModBlocks.COTTONSTAGE_6.get().defaultBlockState();
				BlockState _bso = world.getBlockState(_bp);
