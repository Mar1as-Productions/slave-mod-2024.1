...
public class SlaveRenderer extends HumanoidMobRenderer<SlaveEntity, HumanoidModel<SlaveEntity>> {
	public SlaveRenderer(EntityRendererProvider.Context context) {
