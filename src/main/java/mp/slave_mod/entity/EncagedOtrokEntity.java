...
public class EncagedOtrokEntity extends PathfinderMob {
	public EncagedOtrokEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlaveModModEntities.ENCAGED_OTROK.get(), world);
	}

	public EncagedOtrokEntity(EntityType<EncagedOtrokEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
