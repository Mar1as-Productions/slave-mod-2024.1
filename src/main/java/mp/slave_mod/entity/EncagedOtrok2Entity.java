...
public class EncagedOtrok2Entity extends PathfinderMob {
	public EncagedOtrok2Entity(PlayMessages.SpawnEntity packet, Level world) {
		this(SlaveModModEntities.ENCAGED_OTROK_2.get(), world);
	}

	public EncagedOtrok2Entity(EntityType<EncagedOtrok2Entity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 1;
		setNoAi(false);
