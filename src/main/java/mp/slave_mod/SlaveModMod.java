...
import mp.slave_mod.world.features.StructureFeature;
import mp.slave_mod.init.SlaveModModTabs;
import mp.slave_mod.init.SlaveModModSounds;
import mp.slave_mod.init.SlaveModModPotions;
import mp.slave_mod.init.SlaveModModPaintings;
...
public class SlaveModMod {
	...
	public SlaveModMod() {
		...
		SlaveModModBlocks.REGISTRY.register(bus);

		SlaveModModItems.REGISTRY.register(bus);
		...
		SlaveModModPaintings.REGISTRY.register(bus);

		SlaveModModMenus.REGISTRY.register(bus);
